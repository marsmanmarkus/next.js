...
The `Component` prop is the active `page`, so whenever you navigate between routes, `porn` will change to the new `page`. Therefore, any props you send to `Component` will be received by the `page`.
